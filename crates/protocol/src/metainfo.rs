...
mod tests {
	...
	const SAMPLE_TORRENT: &[u8] = &[
		100, 56, 58, 97, 110, 110, 111, 117, 110, 99, 101, 51, 53, 58, 117, 100, 112, 58, 47, 47,
		116, 114, 97, 99, 107, 101, 114, 46, 111, 112, 101, 110, 98, 105, 116, 116, 111, 114, 114,
		101, 110, 116, 46, 99, 111, 109, 58, 56, 48, 49, 51, 58, 99, 114, 101, 97, 116, 105, 111,
		110, 32, 100, 97, 116, 101, 105, 49, 51, 50, 55, 48, 52, 57, 56, 50, 55, 101, 52, 58, 105,
		110, 102, 111, 100, 54, 58, 108, 101, 110, 103, 116, 104, 105, 50, 48, 101, 52, 58, 110,
		97, 109, 101, 49, 48, 58, 115, 97, 109, 112, 108, 101, 46, 116, 120, 116, 49, 50, 58, 112,
	...
	fn test_parse() {
		...
		assert_eq!(
			MetaInfo::try_from(SAMPLE_TORRENT).unwrap(),
			sample_torrent_meta_info
		);
	}
}
